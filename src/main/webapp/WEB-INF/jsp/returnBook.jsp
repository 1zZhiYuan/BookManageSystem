...
<header>
    ...
    <div class="breadcrumb">
        <a href="/">首页</a> > <a href="/return-book">还书</a>
    </div>
</header>

<main>
    <h2>还书</h2>
    <p>请选择您已借阅的书籍，提交还书请求。</p>
    <form action="/return-book" method="post">
        <label for="borrowedBookId">选择已借书籍：</label>
        <select id="borrowedBookId" name="borrowedBookId" required>
